...
//
router.get('/economics', adminController.getAllEconomics);
router.get('/economics/:id', adminController.getEconomicsById);
router.post('/economics', adminController.createEconomics);
router.put('/economics/:id', adminController.updateEconomics);
router.delete('/economics/:id', adminController.deleteEconomics);
